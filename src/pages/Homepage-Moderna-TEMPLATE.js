...
//
// INSTRUÇÕES:
// 1. Crie uma nova página no Editor Wix chamada "Homepage Moderna" (ou nome de sua escolha)
// 2. O Wix criará um arquivo automaticamente (ex: Homepage Moderna.xxxxx.js)
// 3. Copie o conteúdo deste arquivo para o arquivo criado pelo Wix
...
// ============================================
// GUIA DE IMPLEMENTAÇÃO NO EDITOR WIX
// ============================================
/*
 * COMO USAR ESTE ARQUIVO:
 * 
 * 1. No Editor Wix, crie uma nova página chamada "Homepage Moderna"
 * 2. O Wix criará automaticamente um arquivo (ex: Homepage Moderna.xxxxx.js)
 * 3. Copie TODO o conteúdo deste arquivo para o arquivo criado pelo Wix
 ...
 * - Subtítulo: ID = "heroSubtitle" (Text)
 * - Botão CTA Primário: ID = "heroCtaPrimary" (Button)
 * - Botão CTA Secundário: ID = "heroCtaSecondary" (Button)
 * - Hero Card (opcional): Container com:
 *   - Status: ID = "heroCardStatus" (Text)
 *   - Título: ID = "heroCardTitulo" (Heading)
 *   - Benefícios: ID = "heroCardBenefit1", "heroCardBenefit2", "heroCardBenefit3" (Text)
 *   - Frase: ID = "heroCardFrase" (Text)
 * 
 * BENEFITS SECTION:
 * - Container: ID = "sectionBenefits" (Box)
 * - Card 1: ID = "benefitCard1" (Box)
 *   - Título: ID = "benefitCard1Title" (Heading)
 *   - Texto: ID = "benefitCard1Text" (Text)
 * - Card 2: ID = "benefitCard2" (Box)
 *   - Título: ID = "benefitCard2Title" (Heading)
 *   - Texto: ID = "benefitCard2Text" (Text)
 * - Card 3: ID = "benefitCard3" (Box)
 *   - Título: ID = "benefitCard3Title" (Heading)
 *   - Texto: ID = "benefitCard3Text" (Text)
 * 
 * COMO FUNCIONA:
 * - Container: ID = "sectionHow" (Box)
 * - Título: ID = "howTitulo" (Heading)
 * - Subtítulo: ID = "howSubtitulo" (Text)
 * - Passo 1: ID = "step1" (Box)
 *   - Título: ID = "step1Title" (Heading)
 *   - Descrição: ID = "step1Desc" (Text)
 * - Passo 2: ID = "step2" (Box)
 *   - Título: ID = "step2Title" (Heading)
 *   - Descrição: ID = "step2Desc" (Text)
 * - Passo 3: ID = "step3" (Box)
 *   - Título: ID = "step3Title" (Heading)
 *   - Descrição: ID = "step3Desc" (Text)
 * 
 * ONDE ENCONTRAR:
 * - Container: ID = "sectionMaps" (Box) - IMPORTANTE para scroll
 * - Badge: ID = "mapsBadge" (Text)
 * - Título: ID = "mapsTitulo" (Heading)
 * - Subtítulo: ID = "mapsSubtitulo" (Text)
 * - Para cada posto (1, 2, 3):
 *   - Card: ID = "posto1", "posto2", "posto3" (Box)
 *   - Nome: ID = "posto1Nome", "posto2Nome", "posto3Nome" (Heading)
 *   - Endereço: ID = "posto1Endereco", "posto2Endereco", "posto3Endereco" (Text)
 *   - Botão Maps: ID = "posto1Maps", "posto2Maps", "posto3Maps" (Button)
 *   - Botão Waze: ID = "posto1Waze", "posto2Waze", "posto3Waze" (Button)
 * 
 * TELEBUSCA:
 * - Container: ID = "sectionTelebusca" (Box)
 * - Título: ID = "telebuscaTitulo" (Heading)
 * - Título Destaque: ID = "telebuscaTituloHighlight" (Heading)
 * - Texto: ID = "telebuscaTexto" (Text)
 * - Benefício 1: ID = "telebuscaBenefit1" (Text)
 * - Benefício 2: ID = "telebuscaBenefit2" (Text)
 * - Benefício 3: ID = "telebuscaBenefit3" (Text)
 * - Botão: ID = "telebuscaButton" (Button)
 * - Horário: ID = "telebuscaHorario" (Text)
 * 
 * FOOTER:
